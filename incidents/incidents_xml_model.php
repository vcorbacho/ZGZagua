 ...
 */
  ...
  class model_incident_xml{
 	 ...
 	 * Fecha de inicio
 	 */
 	protected $fecha_inicio = ''; // Fecha de inicio
 	/**
 	 ...
 	 */
 	protected $wgs84 = true; // Si es true, coordenadas compatibles con gmaps
 	/**
 	 * URL del servicio
 	 */
 	...
 	function load_xml() {
 		// Comprobamos si hay que usar coordenadas de googlemaps
 		if ( $this->wgs84 ) $wgs84 = 'wgs84'; else $wgs84 = '';
