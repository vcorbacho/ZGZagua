 ...
 */
 class model_user {
 	 ...
 	 * @param Array $arrayotps Array de atributos
 	 */
 	 function set( $arrayopts ) {
 	 	if( isset( $arrayopts[ 'id' ] ) ) $this->id = $arrayopts[ 'id' ];
 	 	if( isset( $arrayopts[ 'registration_date' ] ) ) $this->registration_date = $arrayopts[ 'registration_date' ];
 	 	if( isset( $arrayopts[ 'email' ] ) ) $this->email = $arrayopts[ 'email' ];
 	 	if( isset( $arrayopts[ 'last_notified' ] ) ) $this->last_notified = $arrayopts[ 'last_notified' ];
 	 	if( isset( $arrayopts[ 'active' ] ) ) $this->active = $arrayopts[ 'active' ];
 	 	if( isset( $arrayopts[ 'active_key' ] ) ) $this->active_key = $arrayopts[ 'active_key' ];
 	 	if( isset( $arrayopts[ 'password' ] ) ) $this->password = $arrayopts[ 'password' ];
 	 }
